...
import static back.logica.basededatos.seguridad.Consultas.SP_USUARIOS_INSERT_OTP;
import static back.logica.basededatos.seguridad.Consultas.SP_USUARIOS_SELECT_X_UUID_OTP;


@Service
public class UsuarioDB extends DBCoreService {


    SerializadorService serializadorService;

    @Autowired
    UsuarioDB(SerializadorService serializadorService) {
